...
parser.add_argument('-opt', type=str, help='Path to options YMAL file.', default="config/train/train_DRLN_x4.yml")
...
paddle.save(ckpt_pd, 'trans_weights/trans_DRLN_x4.pdparams')
a = 1